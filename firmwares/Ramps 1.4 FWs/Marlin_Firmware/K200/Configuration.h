...
//  #define DELTA_RADIUS 135.4 //(DELTA_SMOOTH_ROD_OFFSET-(DELTA_EFFECTOR_OFFSET)-(DELTA_CARRIAGE_OFFSET))
  #define DELTA_RADIUS 112.0 //(DELTA_SMOOTH_ROD_OFFSET-(DELTA_EFFECTOR_OFFSET)-(DELTA_CARRIAGE_OFFSET))
...
#define STRING_CONFIG_H_AUTHOR "(HE3D, 2018/12/18)" // Who made the changes.
